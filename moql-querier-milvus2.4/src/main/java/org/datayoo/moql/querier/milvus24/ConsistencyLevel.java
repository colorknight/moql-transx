...
public class ConsistencyLevel extends AbstractFunction {
  ...
  protected io.milvus.v2.common.ConsistencyLevel consistencyLevel;

  public ConsistencyLevel(List<Operand> parameters) {
    super(FUNCTION_NAME, 1, parameters);
    String v = (String) parameters.get(0).operate((EntityMap) null);
    consistencyLevel = io.milvus.v2.common.ConsistencyLevel.valueOf(
        v.toUpperCase());
  }
  ...
  public io.milvus.v2.common.ConsistencyLevel getConsistencyLevel() {
